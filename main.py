...
if __name__ == '__main__':
   ...
   #--------------------------------------------------------------------------------------#
    ...
    model_save_path = os.path.join(
        args.save_folder, Path(f"{args.model['encoder']}/{args.criterion['name']}/model"))
    os.makedirs(model_save_path, exist_ok=True)

    result_save_path = os.path.join(
        args.save_folder, Path(f"{args.model['encoder']}/{args.criterion['name']}/result"))
    os.makedirs(result_save_path, exist_ok=True)

    config_clone_path = os.path.join(
        args.save_folder, Path(f"{args.model['encoder']}/{args.criterion['name']}/config"))
